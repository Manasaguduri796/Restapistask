...
public class KafkaProducerService {
    ...
    public void getByStatusKafka(String datasetStatus,String method, String initiatedAt, String eventType, String message, String status) {
        Map<String, Object> event = new LinkedHashMap<>();
        event.put("event_Type", eventType);
        event.put("TimeStamp", Instant.now().toString());

        Map<String, Object> actions = new LinkedHashMap<>();
        actions.put("Dataset_Status_filter", datasetStatus);
        actions.put("Method", method);
        actions.put("initiated_at", initiatedAt);
